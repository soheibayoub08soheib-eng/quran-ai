...
def analyze_audio():
    try:
        ...
        تعليقات صارمة جداً للتقييم:
        1. دقق في الحفظ، صحة الكلمات، ومخارج الحروف، وأحكام التجويد الأساسية بناءً على الرواية المحددة ({riwaya}). إذا كان الملف الصوتي عبارة عن صوت عشوائي، موسيقى، كلام عادي، أو سورة أخرى غير المحددة، اعتبره فوراً (خطأ/فشل) ولا تقبله أبداً.
